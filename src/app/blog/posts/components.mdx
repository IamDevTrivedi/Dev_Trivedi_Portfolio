                ...
                items={[
                    {
                        ...
                        content: (
                            <Text variant="body-default-s" onBackground="neutral-weak">
                                This is the content for section 1. You can include any components
                                here.
                            </Text>
                        ),
                    },
                    {
                        ...
                        content: (
                            <Text variant="body-default-s" onBackground="neutral-weak">
                                This is the content for section 2. Accordions are great for FAQs and
                    ...
                    },
                    {
                        ...
                        content: (
                            <Text variant="body-default-s" onBackground="neutral-weak">
                                This is the content for section 3. They help save space by hiding
                                content until needed.
                            </Text>
                        ),
                    },
                ]}
                ...
                <Card href=" " maxWidth={20} radius="l-4" direction="column" padding="4" gap="8">
                    ...
                    <Column fillWidth padding="12" gap="8" horizontal="start">
                        ...
                        <Text variant="body-default-s" onBackground="neutral-weak" align="left">
                            This is a description of the card. It can contain multiple lines of
                            text.
                        </Text>
                    </Column>
                </Card>
